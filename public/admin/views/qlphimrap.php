<?php
include_once("../controllers/qlphimrap_control.php");
	...
	<fieldset>
		...
		<form id="qlphimrap-form" class="form" name="qlphimrap_form" action="?act=qlphimrap&code=<?=$code?>" method="post">
			...
			<div class="form-group">
				...
				<input onkeydown="return false"  type="text" class="form-control" id="f_start" name="start_date" value="<?=$phimrap['start_date']?>">
			</div>
			<div class="form-group">
				<label for="f_end">Ngày kết thúc (*)</label>
				<input onkeydown="return false"  type="text" class="form-control" id="f_end" name="end_date" value="<?=$phimrap['end_date']?>">
			</div>
