    ...
    <header class="header-container-full">
        ...
        <div class="header-language-container">
          ...
          <div class="header-language-container-right">     
            <div class="header-top-account">
              <div class="links">
                <ul>
                  <li class=" last" id="top_register">Chào <?=$user['name']?> - <a href="<?=$root?>controllers/logout_control.php">Đăng xuất</a></li>
                </ul>
              </div>
            </div>
          </div>        
      ...
      <div id="header">
        <div class="page-header-container">
          <a class="logo" href="<?=$root?>views/index.php">
           ...
           <li role="presentation"><a href="?act=qlve">VÉ</a></li>
            ...
            <li role="presentation" class="dropdown">
              ...
              <ul class="dropdown-menu">
               ...
               <li <?php if($_SESSION['level'] == 1) echo "style='display:none'"; ?>><a class="level1" href="?act=qluser">Quản lý nhân viên</a></li>
             </ul>
           </li>
