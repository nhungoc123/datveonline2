<?php
include_once("../controllers/qlve_control.php");
	...
	<fieldset>
		...
		<form id="qlve-form" class="form" name="qlve_form" action="?act=qlve&code=<?=$code?>" method="post">
			...
			<div class="form-group">
				...
				<select  id="movie_cinema_id" name="movie_cinema_id" onchange="chon_phimrap(this,'../controllers/load_lich_chieu.php','showtime_id')" class="form-control"  style="width:365px">
			...
			<div class="form-group">
				...
				<select  id="f_rap" name="cinema_id" onchange="chon_rap(this,'../controllers/load_ghe.php','seat_id')" class="form-control"  style="width:365px">
			...
			<div class="form-group">
				...
				<input  type="text"  onkeydown="return false"  class="form-control" id="f_date" name="date" value="<?=$ve['date']?>">
			</div>
